...
const Hero = () => {
  ...
  return (
    <section className='flex flex-col m-auto w-full my-10 '>
        ...
        <div className=" mt-5">
           <Link href={"https://aryanpamwani.in/contact"}><Button variant={lightTheme?'default_borderless':'dark_borderless'} className="inter w-11/12 transition-theme px-8 py-4">Hire Me</Button></Link>
        </div>
        </div>
    </section>
  )
