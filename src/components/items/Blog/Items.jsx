...
const BlogItems = ({imgUrl,title,desc,category,postId}) => {
  ...
  return (
    ...
    <div className={lightTheme?"blogpost footer-light ":"blogpost blogpost-dark"}>
      ...
      <div class="p-6">
        ...
        <div className="flex items-center flex-wrap opens-sans">
        <Link href={`/blog/${postId}`} className="text-blue-500 cursor-pointer inline-flex items-center md:mb-2 lg:mb-0">Learn More
